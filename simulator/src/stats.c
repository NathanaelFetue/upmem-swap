...
void stats_export_csv(swap_stats_t *stats, const char *filename)
{
    ...
    fprintf(f, "swapouts,swapins,avg_swapout_us,avg_swapin_us,avg_cpu_compress_us,avg_cpu_decompress_us,avg_cpu_overhead_us,avg_dpu_compress_us,compression_ratio,hit_rate\n");
    
    /* Data */
        fprintf(f, "%s,%u,%u,%u,%s,%lu,%lu,%lu,%lu,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f\n",
            ...
            stats->avg_swapin_us,
            stats->avg_cpu_compress_us,
            stats->avg_cpu_decompress_us,
